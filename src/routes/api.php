 ...
 */
Route::get('/', function(){
  return response()->json(['name'=>'Mahendra Bagada']);
});
...
/**
 * Get user list that chat not started
 */
Route::get('/getUserList', 'MessagesController@getUserNotInChatList')->name('api.contacts.get.notlist');
